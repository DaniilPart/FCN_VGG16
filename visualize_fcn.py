...
# Симуляция выходов энкодера VGG16
layer3_out = Conv2D(256, (3,3), padding='same', activation='relu', name='vgg_layer3_out')(inputs)
...
plot_model(model, to_file='fcn_vgg16_architecture.png', show_shapes=True, show_layer_names=True)
print('Схема сохранена в fcn_vgg16_architecture.png')
